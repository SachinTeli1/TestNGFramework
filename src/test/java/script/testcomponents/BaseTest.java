...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				System.getProperty("user.dir") + "/src/main/java/script/resource/GlobalData.properties");
	...
	public String getScreenShot(String test) throws IOException {
		...
		File file = new File(System.getProperty("user.dir") + "/Reports/" + test + ".png");
		FileUtils.copyFile(source, file);
		return System.getProperty("user.dir") + "/Reports/" + test + ".png";
	}
